...
// let variable3: string | null | undefined = "Hola";
...
function setMensaje(mensaje: string): void {
  // Dispone del tipo void para funciones sin retorno
  console.log(mensaje);
}
...
function multiplicacion(
  ...
  return mensaje
    ? mensaje + operando1 * operando2
    : "El resultado es " + operando1 * operando2;
}

const resultado1 = multiplicacion(10, 5);
const resultado2 = multiplicacion(2, 4, "Solución: ");

//Otro ejemplo de argumento opcional ?
...
saludar("Maria", "Gonzalez"); // Hola Maria Gonzalez
